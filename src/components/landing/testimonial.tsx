...
const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    image: r3,
    quote:
      "আমাদের মেয়ে সানায়ার অন্নপ্রাশনের প্রতিটি মুহূর্তকে এত সুন্দরভাবে প্রাণবন্ত করে তোলার জন্য অসংখ্য ধন্যবাবা। তোমার ধৈর্য, একাগ্রতা এবং কাজের প্রতি ভালোবাসা সত্যিই প্রশংসনীয়। তোমার মতো একজন ফটোগ্রাফার আমাদের বিশেষ দিনটিকে আরও স্মরণীয় করে তুলেছে। 😊💖",
    rating: 5,
  },
  {
    name: "Arindam Ghosh",
