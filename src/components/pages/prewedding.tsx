...
export default function PreWedding({
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.from(".pw-top-rule", { scaleX: 0,  duration: 1.6, transformOrigin: "center" }, 0)
        .from(".pw-eyebrow",  { opacity: 0, y: -10, duration: 1 }, 0.15)
        .from(".pw-title",    { opacity: 0, y: 28,  duration: 1.4 }, 0.28)
        .from(".pw-subtitle", { opacity: 0, y: 14,  duration: 1.1 }, 0.5)
        .from(".pw-bot-rule", { scaleX: 0,  duration: 1.4, transformOrigin: "center" }, 0.55)
        .from(".pw-desc",     { opacity: 0, y: 10,  duration: 1 }, 0.7)
        .from(".pw-meta",     { opacity: 0,          duration: 0.9 }, 0.85);
    }, headingRef);
    return () => ctx.revert();
  }, []);
