...
export default function Engagement({
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.from(".eng-top-rule",  { scaleX: 0,  duration: 1.6, transformOrigin: "center" }, 0)
        .from(".eng-eyebrow",   { opacity: 0, y: -10, duration: 1 }, 0.15)
        .from(".eng-title",     { opacity: 0, y: 28,  duration: 1.4 }, 0.28)
        .from(".eng-subtitle",  { opacity: 0, y: 14,  duration: 1.1 }, 0.5)
        .from(".eng-bot-rule",  { scaleX: 0,  duration: 1.4, transformOrigin: "center" }, 0.55)
        .from(".eng-desc",      { opacity: 0, y: 10,  duration: 1 }, 0.7)
        .from(".eng-meta",      { opacity: 0,          duration: 0.9 }, 0.85);
    }, headingRef);
    return () => ctx.revert();
  }, []);
